...
const HomePage: React.FC = () => {
  ...
  const [isVisible, setIsVisible] = useState({ text1: false, text2: false, text3: false });
  ...
  useEffect(() => {
    ...
    }, { threshold: 0.5 }); // 요소가 뷰포트의 50% 보일 때 트리거
  ...
  return (
    <div>
      ...
      <Text ref={text1Ref} id="text1" isVisible={isVisible.text1}>Text 1</Text>
      <Text ref={text2Ref} id="text2" isVisible={isVisible.text2}>Text 2</Text>
      <Text ref={text3Ref} id="text3" isVisible={isVisible.text3}>Text 3</Text>
    </div>
  );
};
